...
from lib_viagens import dados_viagem,otimizar,buscarmenor,dic_datas,i_produtos,peso_tempo,lista_cidades,peso_atraso,TravellingSalesmanProblem
...
async def travel_otimizada (lista_t:list):
    ...
    for va in init_state:
        for vb in init_state:
            ...
            distance_matrix[va][vb] = distancia * peso_preco * peso_atraso(va, vb, lista_t)
